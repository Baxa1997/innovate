    ...
    <main className={styles.main}>
      ...
      <MotionSection className={styles.termsWrapper}>
        <div className={styles.container}>
          ...
          >
            These terms of service (`&quot;`Agreement`&quot;`) constitute a
            contract between you and Zero Max ELD Inc, a Pennsylvania limited
            liability corporation, together with its employees, consultants,
            directors, successors, subsidiaries, affiliates, and assignees
            (`&quot;`Company`&quot;`, `&quot;`we`&quot;` or `&quot;`us`&quot;`)
            and governs the terms under which you may use services offered by
            us, whether on behalf of yourself or on behalf of a company or other
            ...
            The terms `&quot;`you`&quot;` or `&quot;`your`&quot;` throughout
            this Agreement shall mean you personally and/or the entity on whose
            behalf you are acting.
            <br />
            Description of the Service. The service means the Company`&apos;`s
            ...
            contractors (`&quot;`End Users`&quot;`) to access the Services in
            accordance with this Agreement. You may have the ability to create
            End User accounts with special permissions (`&quot;`Administrator
            Accounts`&quot;`). To the extent that you create any accounts for
            End Users, direct us to create any accounts for End Users, or allow
            End Users to access the Services, (including End Users with
            Administrative Accounts), you and your End Users are responsible for
            all End Users`&apos;` activity and ensuring that they are in
            ...
            the FMCSA. Please also refer to the Section entitled
            `&quot;`Disclaimer of Warranties`&quot;` in this Agreement.
            <br />
            ...
            access and use the Service, you`&apos;`ll have to create, or be
            granted, an account. You can do this via the Service. It`&apos;`s
            ...
            information to keep it accurate, complete and up-to-date. If you
            don`&apos;`t, we might have to suspend or terminate your account.
            You agree that you won`&apos;`t disclose your login credentials or
            account password to anyone and you`&apos;`ll notify us immediately
            of any unauthorized use of your account. You are responsible for all
            activities that occur under your account, whether or not you know
            about them. Your use of the Service is dependent on a variety of
            factors for which you are solely responsible including but not
            limited to operation of a vehicle that is capable of connection with
            and Zero Max ELD of information to the Service, use of a device
            which is capable of downloading and/or accessing the Service, and
            access to an internet or cellular connection with which to access
            the Service.
            <br />
            ...
            click here.
            <br />
            `&quot;`Your Data`&quot;` means any data and content you create,
            post, upload, transmit or otherwise make available via the Services
            (which may include data you elect to import from Non-Company
            products you use). `&quot;`Your Data`&quot;` includes logs you
            create, location coordinates that are collected, certain vehicle
            data, messages you send, documents you upload, profile information
            and anything else you enter or upload into the Service.
            <br />
            ...
            commercial motor vehicle driver (`&quot;`Driver`&quot;`) to connect
            directly with a motor carrier (`&quot;`Carrier`&quot;`), allowing
            Drivers to send messages and automatically share their driving logs,
            documents, location information and other data (`&quot;`Driver
            Data`&quot;`) with the Carrier. When Drivers connect with a Carrier
            through the Services, the Carrier, its employees and other third
            parties who are also connected to that Carrier may access Driver
            Data for all Drivers who are connected to that same Carrier.
            <br />
            If a Driver connects with a Carrier, the Driver should be aware that
            the Driver`&apos;`s Driver Data will be automatically shared with
            that Carrier and with such other parties described above. Please
            consider carefully the parties with whom you choose to connect and
            what you choose to share. Company’s role in this process is solely
            to provide the Service. You are responsible for anything you share,
            including but not limited to Driver Data, via your use of the
            Service. For clarification purposes, you grant us the necessary
            licenses to Your Data for us to create aggregated and/or
            de-identified data for our use in providing the Service and
            otherwise. Notwithstanding anything else in this Agreement, we may
            use and sell such aggregated and/or de- identified data, which does
            ...
            law or regulation. We are not responsible for the accuracy,
            ...
            enable any other individual to do any of the foregoing. Although
            we`&apos;`re not obligated to monitor access to or use of the
            Service or to review or edit the Service or Your Data, we have the
            ...
            obligated, to disable your access at our sole discretion. If we
            suspect, in our reasonable opinion, fraudulent or unauthorized
            activity on your account, we reserve the right to terminate or
            suspend your access to our website or any applicable services or
            both. We have the right to investigate violations of this Agreement
            or conduct that affects the Service. We may also consult and
            ...
            PURPOSE, QUIET ENJOYMENT AND NONgINFRINGEMENT AND ANY WARRANTIES
            ARISING OUT OF COURSE OF DEALING OR USAGE OF TRADE. COMPANY
            EXPLICITLY DISCLAIMS ALL LIABILITY FOR ANY ACT OR OMISSION OF ANY
            DRIVER, USER, END USER, ENTITY OR OTHER THIRD PARTY. We make no
            ...
            truthfulness, completeness or reliability of any the Service or
            anything shared by any users of the Service. Your use of the Service
            is at your sole risk and discretion and Company hereby disclaims any
            and all liability to you or any third party relating thereto.
            <br />
            ...
            connection to the Service, your violation of this Agreement or any
            ...
            third party due to or arising out of your use of the Service, your
            connection to the Service, your violation of this Agreement or any
            law, or your violation of any rights of a third party. Additional
            Terms for Apple Applications. The terms in this section apply to
            your use of the Service, including the iPhone and iPad applications
            available via the Apple, Inc. (`&quot;`Apple`&quot;`h App Store
            (each an `&quot;`App Store App`&quot;`), but the following
            additional terms also apply to App Store Apps: Both you and Company
            acknowledge that this Agreement is concluded between you and Company
            only, and not with Apple, and that Apple is not responsible for App
            Store Apps or the Content; The App Store Apps are licensed to you on
            a limited, non-exclusive, non-transferable, non- sublicensable
            basis, solely to be used in connection with the Service for your
            ...
            You will only use the App Store Apps in connection with an Apple
            device that you own or control; You acknowledge and agree that Apple
            has no obligation whatsoever to furnish any maintenance and support
            services with respect to the App Store Apps; In the event of any
            failure of the App Store Apps to conform to any applicable warranty,
            including those implied by law, you may notify Apple of such
            failure; upon notification, Apple`&apos;`s sole warranty obligation
            to you will be to refund to you the purchase price, if any, of the
            App Store App; You acknowledge and agree that Company, and not
            Apple, is responsible for addressing any claims you or any third
            party may have in relation to the App Store App; You acknowledge and
            agree that, in the event of any third party claim that the App Store
            App or your possession and use of the App Store App infringes that
            third party`&apos;`s intellectual property rights, Company, and not
            Apple, will be responsible for the investigation, defense,
            settlement and discharge of any such infringement claim; You
            represent and warrant that you are not located in a country subject
            ...
            prohibited or restricted parties; Both you and Company acknowledge
            and agree that, in your use of the App Store App, you will comply
            with any applicable third party terms of agreement which may affect
            or be affected by such use; and Both you and Company acknowledge and
            ...
            Service or this Agreement (a `&quot;`Claim`&quot;`) shall be
            governed by and construed in accordance with the laws of
            Pennsylvania, except that body of law governing conflicts of law.
            Dispute Resolution. If a dispute arises between you and Company, our
            goal is to learn about and address your concerns. If we are unable
            to address your concerns to your satisfaction, we will seek to
            provide you with a neutral and cost-effective means of resolving the
            dispute quickly. Complaints and disputes between you and Company
            regarding the Service may be reported to Attn: Legal Department,
            Zero Max ELD Inc, 222 Katie Dr Feasterville Trevose, PA 19053,
            Warminster, PA 18974 or via email to: support@zeromaxeld.com.
            ...
            than $10,000.00 USD, the party requesting relief may elect to
            resolve the dispute in a cost-effective manner through binding non-
            appearance-based arbitration. If a party elects arbitration, that
            ...
            parties must comply with the following rules: (i) the arbitration
            shall be conducted by telephone, online and/or be solely based on
            written submissions, with the specific manner to be chosen by the
            party initiating the arbitration; (ii) the arbitration shall not
            ...
            competent jurisdiction. Forum for Disputes. Except as otherwise
            agreed by the parties or as described above, you agree that any
            claim or dispute you may have against Company must be resolved by a
            court located in Philadelphia County , Pennsylvania. You agree to
            submit to the personal jurisdiction of the courts located within
            Philadelphia County, Pennsylvania for the purpose of litigating all
            such claims or disputes. Improperly Filed Litigation. All claims you
            bring against Company must be resolved in accordance with this
            Agreement. All claims filed or brought contrary to this Agreement
            shall be considered improperly filed, and a breach of this
            Agreement. Should you file a claim contrary to this Agreement,
            Company may recover attorneys`&apos;` fees and costs from you,
