...
export const metadata = {
    ...
    description: "Blue Star ELD™ delivers an innovative Fleet Management and Electronic Logging system that empowers carriers and drivers with various advanced features.",
    openGraph: {
        type: "website",
        locale: "uz_UZ",
